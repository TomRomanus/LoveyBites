...
const CookingStepsPanel = ({ steps, currentIndex, stepDir, currentIngredients, onGoTo }: CookingStepsPanelProps) => {
      ...
      <AnimatePresence mode="popLayout" custom={stepDir}>
        ...
        >
          ...
          {steps[currentIndex - 1] && (
            <>
              <button onClick={() => onGoTo(currentIndex - 1)} style={{
          ...
          <div style={{ padding: '0 22px' }}>
            {current.sectionTitle && (
              <>
                ...
                <div style={{ width: 22, height: 1.5, background: SECTION_HEADER_COLOR, borderRadius: 1, opacity: 0.6, marginBottom: 10 }} />
              </>
            )}

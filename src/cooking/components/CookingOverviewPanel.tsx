...
import type { FlatStep } from '../types/cooking'
...
const CookingOverviewPanel = ({ steps, currentIndex, ingredientMap, onGoTo }: CookingOverviewPanelProps) => {
        ...
        return (
          <div key={i} data-active={isActive}>
            ...
            <button onClick={() => onGoTo(i)} style={{
              ...
              <div style={{ fontFamily: 'var(--serif)', fontStyle: 'italic', fontSize: 22, color: isActive ? SECTION_HEADER_COLOR : 'rgba(248,244,237,0.5)', fontWeight: 500, width: 22, flexShrink: 0, lineHeight: 1.1, paddingTop: 1 }}>
                {s.num}
              </div>

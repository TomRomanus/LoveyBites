...
import { X, Minus, Plus, ChevronLeft, ArrowRight, Check } from 'lucide-react'
...
const IngredientList = ({ nodes, pathPrefix, depth, checked, onToggle }: IngredientListProps) => (
...
const flattenCookSteps = (nodes: TreeNode[], sectionTitle?: string, counter = { n: 0 }): FlatStep[] => {
